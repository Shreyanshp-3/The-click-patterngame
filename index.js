...
// var gamepattern = [];
// //to store the patter that the user had clicked
...
// //=====================================================
// //to detects when the buttons are triggered
// $(".btn").click(function () {
//   //to store the id of the button that got clicked
//   var userChosenColor = $(this).attr(".id");
//   //to push the choosen color in the array
...
//   var randomChooseColor = colorArray[randomNumber];
